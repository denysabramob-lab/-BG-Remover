...
# 2. Перейти в папку (./ нужен из-за дефиса в начале имени)
cd ./-BG-Remover
...
# 3. Запустить установку (Python скрипт - работает везде)
python3 install.py
...
# Перейти в папку (./ нужен из-за дефиса в начале имени)
cd ./-BG-Remover
